...
let ProductsModule = class ProductsModule {
    configure(consumer) {
        consumer.apply(auth_middleware_1.AuthMiddleware).forRoutes(products_controller_1.ProductsController);
    }
};
...
exports.ProductsModule = ProductsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([product_entity_1.Product, supplier_entity_1.Supplier]),
